...
function notifyAdmin($adminEmail, $userEmail, $approvalLink, $declineLink)
{
    ...
    try {
        ...
        $mail->Body    = "A new user has requested registration. Email: <b>$userEmail</b><br><br>
                          <a href='$approvalLink'>Approve Registration</a> | 
                          <a href='$declineLink'>Decline Registration</a>";
        $mail->AltBody = "A new user has requested registration. Email: $userEmail. 
