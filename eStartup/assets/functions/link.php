...
function generateApprovalLink($email, $hashedPassword)
{
    ...
    return "http://13.60.229.207/eStartup/eStartup/assets/admin/approval.php?action=approve&token=$token";
}
...
function generateDeclineLink($email)
{
    ...
    return "http://13.60.229.207/eStartup/eStartup/assets/admin/approval.php?action=decline&token=$token";
}