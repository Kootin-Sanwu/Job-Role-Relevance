...
function generateApprovalLink($email, $hashedPassword)
{
    ...
    return "http://localhost/eStartup/eStartup/assets/admin/approval.php?action=approve&token=$token";
}
...
function generateDeclineLink($email)
{
    ...
    return "http://localhost/eStartup/eStartup/assets/admin/approval.php?action=decline&token=$token";
}